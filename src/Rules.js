...
class Rule {
  ...
  freq(dice) {
    // frequencies of dice values - Ex [1,2,2,2,1] would give [2,3] (two of same thing, three of same thing)
    const freqs = new Map();
...
const yahtzee = new Yahtzee({ score: 50, description: "50 points for all yahtzee" });
